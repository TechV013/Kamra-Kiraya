        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl text-white">StayFinder</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a href="mailto:support@stayfinder.in" className="text-sm text-gray-400 hover:text-white transition-colors">
