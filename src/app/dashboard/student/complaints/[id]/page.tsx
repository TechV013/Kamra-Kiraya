...
import { ArrowLeft, Send, CheckCircle, User, Calendar, Tag, AlertTriangle, Loader2 } from "lucide-react";
...
export default function StudentComplaintDetailPage() {
  ...
  const isComplainant = complaint.complainant.id === user?.id;
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 py-10">
      <div className="max-w-4xl mx-auto px-4">
        ...
        {showResolve && (
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm p-6 mb-6">
            <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Mark as Resolved?</h3>
