      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl bg-white p-8 shadow-xl dark:bg-gray-900">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Owner Profile</h1>
              <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Update your owner account and contact details.</p>
            </div>
