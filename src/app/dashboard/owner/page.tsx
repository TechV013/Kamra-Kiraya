    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            { label: "Total Listings", value: stats.totalRooms, icon: Building2, color: "indigo" },
            { label: "Approved", value: stats.approvedRooms, icon: CheckCircle, color: "green" },
            { label: "Bookings", value: stats.totalBookings, icon: BookOpen, color: "purple" },
            { label: "Revenue", value: `₹${totalRevenue.toLocaleString()}`, icon: TrendingUp, color: "blue" },
          ].map((s, i) => (
            <motion.div
              key={s.label}
        ...
        {stats.pendingBookings > 0 && (
          <div className="flex items-center gap-3 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-2xl mb-6">
            ...
            <button
              ...
              className="ml-auto text-sm font-medium text-yellow-700 dark:text-yellow-300 underline"
            >
              Review now
            </button>
          </div>
                  ...
                  >
                    <div className="flex flex-col sm:flex-row gap-4 p-5">
                      <div className="sm:w-28 h-24 rounded-xl overflow-hidden bg-gray-100 dark:bg-gray-700 shrink-0">
                        <img
                          src={room.images?.[0] || "https://images.unsplash.com/photo-1555854877-bab0e564b8d5?w=200&q=80"}
                          alt={room.title}
